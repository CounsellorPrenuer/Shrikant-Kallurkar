  ...
  return (
    <section id="testimonials" className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-muted/30">
      <div className="max-w-7xl mx-auto" ref={ref}>
        ...
        >
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4" data-testid="text-testimonials-headline">
            What Clients Say
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Card className="group h-full hover-elevate transition-all hover:shadow-xl bg-card/50 backdrop-blur-sm border-card-border" data-testid={`card-testimonial-${index}`}>
