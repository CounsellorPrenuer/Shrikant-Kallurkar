...
const CMS_PROJECTS: Record<string, string> = {
  ...
  ashokjetawat: "a1ht83cx",
  drganeshdpatil: "xi1ios8w",
  shrikantkallurkar: "viwfdiol",
};
...
const TENANT_PROJECT_IDS = ["ashokjetawat", "shrikantkallurkar"];

function validProject(projectId: string, env: Env) {
  if (projectId === "ashokjetawat" || projectId === "shrikantkallurkar") return true;
